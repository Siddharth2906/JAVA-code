...
<html>
    ...
    <body>
       ...
       <table border='2'>
           ...
           <tr><th>Product ID</th><th>Product Name</th><th>Product Rate/kg</th><th>Delete</th></tr>
       <%
        while(rs.next())
        {
           ...
           %>
           <tr><td><%=id%></td><td><%=name%></td><td><%=price%></td><td><a href='Delete?iidd=<%=id%>'>Delete</a></td></tr>       
      <%     
        }
        out.println("</table>");
        }
